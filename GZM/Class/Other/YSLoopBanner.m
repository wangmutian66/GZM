...
//    [self.middleImageView sizeToFit];
...
//        self.rightImageView.image = [UIImage imageNamed:self.imageURLStrings[rightIndex]];
        ...
        NSString *imageUlrleft=[NSString stringWithFormat:@"http://%@",self.imageURLStrings[leftIndex]];
      
        [self.leftImageView sd_setImageWithURL:[NSURL URLWithString:imageUlrleft] placeholderImage:[UIImage imageNamed:@"AppIcon"]];
        NSString *imageUlrmiddle=[NSString stringWithFormat:@"http://%@",self.imageURLStrings[curIndex]];
        [self.middleImageView sd_setImageWithURL:[NSURL URLWithString:imageUlrmiddle] placeholderImage:[UIImage imageNamed:@"AppIcon"]];
        NSString *imageUlrright=[NSString stringWithFormat:@"http://%@",self.imageURLStrings[rightIndex]];
        [self.rightImageView sd_setImageWithURL:[NSURL URLWithString:imageUlrright] placeholderImage:[UIImage imageNamed:@"AppIcon"]];
