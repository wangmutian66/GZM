...
NSString * const WXAppId = @"wx900520eae73ea184";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [WXApi registerApp:@"wx900520eae73ea184"];
...
//    self.window.rootViewController=tabBarVc;
    //2.1添加控制器
//    UIStoryboard *storyboard=[UIStoryboard storyboardWithName:NSStringFromClass([GuaiTableViewController class]) bundle:nil];
//    GuaiTableViewController *guai=[storyboard instantiateInitialViewController];
